...
<div class="product-detail row <?=$themeClass?>" id="<?=$itemIds['ID']?>">
	<?php
		//region COVER
		?>
		<div class="product-detail-slider-container col-12 col-md-3" id="<?=$itemIds['BIG_SLIDER_ID']?>">
...
<?php
		...
		?>
		<section class="product-detail-props-container col-12 col-md-9 mt-3 mt-sm-0">
					...
					<div class="mb-3">
						...
						$APPLICATION->IncludeComponent(
							...
							array(
								...
								'BUTTON_CLASS' => 'btn product-item-detail-buy-button',
			...
			?>
					...
					<div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
						...
						if ($showAddBtn)
						{
							?>
							<div class="mb-3">
								<a class="product-item-detail-buy-button btn btn-md"
