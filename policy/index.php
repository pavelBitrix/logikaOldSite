...
<!-- <section class="policy">
    <div class="main_title about"> Политика в отношении обработки персональных данных </div>
    <div id="inputResult">
        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                ...
                <div class="descr">
                    ...
                    данных, предпринимаемые <span class="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">ООО "Логика"</span> (далее&nbsp;— Оператор).
                </div>
                <div class="ol">
                    <div class="li">
                    ...
                    <div class="li">
                        ...
                        которую Оператор может получить о&nbsp;посетителях веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://logika1c.ru/</span>.
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col">
                ...
                <div class="ol">
                    ...
                    <div class="li">
                        ...
                        их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://logika1c.ru/</span>.
                    </div>
                    <div class="li">
                    ...
                    <div class="li">2.8. Персональные данные&nbsp;— любая информация,
                        ...
                        Пользователю веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://logika1c.ru/</span>.
                    </div>
                    <div class="li">
                    ...
                    <div class="li">
                        2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span class="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://logika1c.ru/</span>.
                    </div>
                    <div class="li">
        ...
        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                ...
                <div class="ol">
                    <div class="li" id="OKgjG9hWS">
                        <table class="purpose-table">
                            <tbody>
                                <tr>
                                    <th>Цель обработки</th>
                                    <td class="purpose-field"><span class="mark link">уточнение деталей заявки</span></td>
                                </tr>
                                <tr>
            ...
            <div class="col">
                ...
                <div class="ol">
                    ...
                    <div class="li">
                        ...
                        Оператору уведомление на&nbsp;адрес электронной почты Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">LOGIKA1C@MAIL.RU</span>
                    ...
                    <div class="li">
                        ...
                        посредством электронной почты на&nbsp;электронный адрес Оператора <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">LOGIKA1C@MAIL.RU</span>
        ...
        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                ...
                <div class="ol" style="margin-bottom: 10%;">
                    <div class="li">
                        ...
                        к&nbsp;Оператору с&nbsp;помощью электронной почты <span class="link mark owner-email-field" data-scroll-to="#owner-email-field">LOGIKA1C@MAIL.RU</span>.
                    </div>
                    <div class="li">
                    ...
                    <div class="li">
                        ...
                        в&nbsp;сети Интернет по&nbsp;адресу <span id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field">https://logika1c.ru/policy</span>.
                    </div>
                </div>
            </div>
        </div>
...
<section class="policy">
    <div class="main_title about"> Политика в отношении обработки персональных данных ООО «Логика» </div>
    
    <div id="inputResult" style="line-height: 1.6; font-size: 16px; margin-bottom: 10%;">
        
        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">1. Общие положения</h5>
                <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон) и определяет порядок обработки персональных данных и меры по обеспечению их безопасности, предпринимаемые ООО «Логика» (далее — Оператор).</p>
                ...
                <p>1.2. Настоящая политика Оператора применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://logika1c.ru/" id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field" target="_blank">https://logika1c.ru/</a>.</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">2. Основные понятия, используемые в Политике</h5>
                <p>2.1. Автоматизированная обработка персональных данных — обработка персональных данных с помощью средств вычислительной техники.</p>
                <p>2.2. Блокирование персональных данных — временное прекращение обработки персональных данных.</p>
                <p>2.3. Веб-сайт — совокупность графических и информационных материалов, программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по адресу <a href="https://logika1c.ru/" id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field" target="_blank">https://logika1c.ru/</a>.</p>
                <p>2.4. Обезличивание персональных данных — действия, в результате которых невозможно определить без использования дополнительной информации принадлежность персональных данных конкретному Пользователю.</p>
                <p>2.5. Обработка персональных данных — любое действие (операция) или совокупность действий, включая сбор, запись, систематизацию, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передачу (предоставление, доступ), обезличивание, блокирование, удаление, уничтожение персональных данных.</p>
                <p>2.6. Оператор — юридическое лицо ООО «Логика», самостоятельно организующее и осуществляющее обработку персональных данных.</p>
                <p>2.7. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="https://logika1c.ru/" id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field" target="_blank">https://logika1c.ru/</a>.</p>
                <p>2.8. Пользователь — любой посетитель веб-сайта <a href="https://logika1c.ru/" id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field" target="_blank">https://logika1c.ru/</a>.</p>
                <p>2.9. Уничтожение персональных данных — действия, в результате которых персональные данные уничтожаются безвозвратно.</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">3. Основные права и обязанности Оператора</h5>
                <p>3.1. Оператор имеет право получать от субъекта достоверные информацию и документы, содержащие персональные данные.</p>
                <p>3.2. Оператор обязан обеспечивать неограниченный доступ к настоящей Политике и принимать меры для защиты персональных данных от неправомерного доступа.</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">4. Основные права и обязанности субъектов персональных данных</h5>
                <p>4.1. Субъекты персональных данных имеют право получать информацию, касающуюся обработки их данных, требовать их уточнения, блокирования или уничтожения в случае, если данные являются неполными или неточными.</p>
                <p>4.2. Субъекты обязаны предоставлять Оператору достоверные данные о себе.</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">5. Принципы обработки персональных данных</h5>
                <p>5.1. Обработка осуществляется на законной и справедливой основе и ограничивается достижением конкретных, заранее определенных целей.</p>
                <p>5.2. Не допускается обработка персональных данных, избыточных по отношению к заявленным целям.</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">6. Цели обработки персональных данных</h5>
                <p>Оператор осуществляет обработку персональных данных Пользователей для следующих целей (согласно уведомлению в Реестр операторов ПДн):</p>
                
                <p><strong>6.1. Продвижение товаров, работ, услуг на рынке.</strong></p>
                <ul style="margin-bottom: 15px;">
                    <li><strong>Субъекты:</strong> Клиенты, посетители сайта, контрагенты и их представители.</li>
                    <li><strong>Данные:</strong> ФИО, адрес электронной почты, номер телефона, ИНН, а также сведения, собираемые посредством метрических программ.</li>
                </ul>

                <p><strong>6.2. Подбор персонала (соискателей) на вакантные должности.</strong></p>
                <ul style="margin-bottom: 15px;">
                    <li><strong>Субъекты:</strong> Соискатели.</li>
                    <li><strong>Данные:</strong> ФИО, данные о рождении (день, месяц, год), пол, адрес места жительства, телефон, e-mail, профессия, должность, сведения о трудовой деятельности и образовании, фото-видео изображение лица.</li>
                </ul>

                <p><strong>6.3. Ведение кадрового и бухгалтерского учета.</strong></p>
                <ul style="margin-bottom: 15px;">
                    <li><strong>Субъекты:</strong> Работники, их родственники, уволенные работники.</li>
                    <li><strong>Данные:</strong> ФИО, данные о рождении, место рождения, семейное и социальное положение, доходы, пол, контакты, адрес регистрации и жительства, СНИЛС, ИНН, гражданство, паспортные данные, реквизиты банковских карт и счетов, сведения о трудовой деятельности и образовании, отношение к воинской обязанности.</li>
                </ul>

                <p><strong>6.4. Подготовка, заключение и исполнение гражданско-правового договора.</strong></p>
                <ul style="margin-bottom: 15px;">
                    <li><strong>Субъекты:</strong> Физические лица (в т.ч. работники в рамках ГПХ).</li>
                    <li><strong>Данные:</strong> ФИО, данные о рождении, место рождения, пол, контакты, адрес регистрации и жительства, СНИЛС, ИНН, гражданство, паспортные данные, реквизиты банковской карты и счета.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">7. Условия и способы обработки</h5>
                <p>7.1. Правовым основанием обработки персональных данных для всех вышеуказанных целей является согласие субъекта персональных данных на обработку его персональных данных.</p>
                <p>7.2. Способы обработки: автоматизированная обработка с передачей полученной информации по информационно-телекоммуникационным сетям (в т.ч. через сеть Интернет), а также по внутренней сети юридического лица.</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">8. Использование метрических программ</h5>
                <p>8.1. В рамках цели «Продвижение товаров, работ, услуг на рынке» на Сайте используется сервис Яндекс.Метрика.</p>
                <p>8.2. Обработка сведений, собираемых метрической программой (IP-адрес, файлы cookie и др.), осуществляется с согласия Пользователя. Пользователь подтверждает согласие, продолжая использовать Сайт или принимая условия во всплывающем баннере (cookie-banner).</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">9. Порядок сбора, хранения и защиты данных</h5>
                <p>9.1. Оператор обеспечивает сохранность данных и принимает все меры, исключающие доступ к ним неуполномоченных лиц.</p>
                <p>9.2. Персональные данные Пользователя никогда, ни при каких условиях не будут переданы третьим лицам, за исключением случаев, связанных с исполнением действующего законодательства, случаев получения согласия субъекта на передачу для исполнения договора, а также в рамках использования метрических программ (Яндекс.Метрика), указанных в разделе 8 настоящей Политики.</p>
                <p>9.3. Срок обработки данных определяется достижением целей. Срок хранения данных Яндекс.Метрики — до 26 месяцев.</p>
                <p>9.4. Отзыв согласия осуществляется путем направления уведомления на e-mail: <a href="mailto:logika1c@mail.ru" id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field" >LOGIKA1C@MAIL.RU</a> с пометкой «Отзыв согласия на обработку персональных данных».</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">10. Перечень действий с персональными данными</h5>
                <p>10.1. Оператор осуществляет следующие действия с персональными данными: сбор, запись, систематизацию, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передачу (предоставление, доступ), обезличивание, блокирование, удаление, уничтожение, а также распространение (при наличии отдельного согласия субъекта).</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">11. Трансграничная передача персональных данных</h5>
                <p>11.1. Трансграничная передача персональных данных Оператором не осуществляется.</p>
                <p>11.2. Хранение и обработка данных осуществляются исключительно в базах данных на территории Российской Федерации.</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">12. Конфиденциальность</h5>
                <p>12.1. Оператор и иные лица, получившие доступ к данным, обязаны соблюдать конфиденциальность и не раскрывать их третьим лицам без согласия субъекта, если иное не предусмотрено федеральным законом.</p>
            </div>
        </div>

        <div class="row mb-4" style="font-size:20px;font-weight:600;">
            <div class="col">
                <h5 style="font-weight: bold; margin-bottom: 15px;">13. Заключительные положения</h5>
                <p>13.1. Пользователь может получить разъяснения по вопросам обработки данных через e-mail: <a href="mailto:logika1c@mail.ru" id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field" >LOGIKA1C@MAIL.RU</a>.</p>
                <p>13.2. Актуальная версия Политики находится в свободном доступе по адресу: <a href="https://logika1c.ru/policy/" id="owner-privacy-url-value" class="link mark owner-privacy-url-field" data-scroll-to="#owner-privacy-url-field" target="_blank">https://logika1c.ru/policy/</a>.</p>
            </div>
        </div>
