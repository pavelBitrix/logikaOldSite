	...
	<div class="col">
		...
		<div class="row">
			<?foreach($arResult["ITEMS"] as $arItem):?>
				...
				?>
				<div class="news-list-item mb-2 col-3" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					<div class="card logika">
						<?if($arParams["DISPLAY_PICTURE"]!="N"):
							...
							elseif (isset($arItem["PREVIEW_PICTURE"]) && is_array($arItem["PREVIEW_PICTURE"]))
							{
								...
								{
									?>
									<a  class="logika-panel" href="<?= $arItem["DETAIL_PAGE_URL"] ?>">
										<img
											class="card-img-top"
							...
							<div class="d-flex justify-content-between align-items-center">
								<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
									<div class="news-list-more">
										<a class="btn btn-primary btn-sm logika" href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?echo GetMessage("CT_BNL_GOTO_DETAIL")?></a>
									</div>
								<?endif;?>
