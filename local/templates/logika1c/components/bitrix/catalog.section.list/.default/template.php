...
{
?>
<div class="row <? echo $arCurView['LIST']; ?>">
<?
	switch ($arParams['VIEW_MODE'])
	{
		case 'LINE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><div class="col-6 col-sm-3" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
				<div>
				<a
		...
		case 'TILE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><div class="col-6 col-sm-4" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
				...
				{
					?><h2 class="bx_catalog_tile_title_text">
					<? echo $arSection['NAME']; ?><?
					if ($arParams["COUNT_ELEMENTS"] && $arSection['ELEMENT_CNT'] !== null)
					{
						?> <span>(<? echo $arSection['ELEMENT_CNT']; ?>)</span><?
