		...
		<div class="catalog-section-item-description">
			...
			<div class="catalog-section-item-offers-container d-flex justify-content-between align-items-center">
				...
				<div>
					...
					{
						?>
						<button class="catalog-section-item-buy-btn btn btn-md rounded-pill" id="<?=$itemIds['PREBUY_OPEN_BTN']?>">
					...
					{
						?>
						<button class="catalog-section-item-buy-btn btn btn-md rounded-pill disabled" id="<?=$itemIds['NOT_AVAILABLE_MESS']?>" disabled>
							...
							<div class="d-flex mt-3 flex-column justify-content-center">
								...
								if ($actualItem['CAN_BUY'])
								{
									...
									<div id="<?=$itemIds['BASKET_ACTIONS']?>" class="mb-2" <?=($actualItem['CAN_BUY'] ? '' : 'style="display: none;"')?>>
										<button class="catalog-section-item-popup-buy-btn btn btn-md rounded-pill" id="<?=$itemIds['BUY_LINK']?>"
								...
								{
									?>
									<button class="catalog-section-item-popup-buy-btn btn btn-md rounded-pill"
