...
$allowed_origins = [
    'https://vue.logika1c.ru', // Ваш продакшен фронтенд
    'http://localhost:5173',    // <--- ВАШ ЛОКАЛЬНЫЙ VITE URL (замените порт 5173, если нужно)
    'http://127.0.0.1:5173',   // <--- Альтернативный локальный VITE URL (замените порт)
    'http://localhost:5174',    // <--- ВАШ ЛОКАЛЬНЫЙ VITE URL (замените порт 5173, если нужно)
    'http://127.0.0.1:5174',   // <--- Альтернативный локальный VITE URL (замените порт)
    // Можете добавить другие, если необходимо
];
