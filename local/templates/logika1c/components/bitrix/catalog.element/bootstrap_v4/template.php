...
?>
	...
	<!--Название товара-->
	<div class="" id="<?=$itemIds['SMALL_CARD_PANEL_ID']?>">
...
<div>
	<div><h2>Похожие товары</h2></div>
	<div>
	<?$APPLICATION->IncludeComponent("bitrix:catalog.section", "logika_recommendations", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'3','BIG_DATA':true}]",	// Вариант отображения товаров
		...
		"RCM_TYPE" => "similar",	// Тип рекомендации
