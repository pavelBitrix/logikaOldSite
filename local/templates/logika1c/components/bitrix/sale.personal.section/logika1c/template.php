...
else
{
	...
	<div class="row">
		...
		<?if($USER->IsAuthorized()):?>
			...
			<div class="col-lg-3 col-md-4 col-6">
				<div class="sale-personal-section-index-block bx-red">
					<a class="sale-personal-section-index-block-link" href="/?logout=yes&<?=bitrix_sessid_get()?>">
						<span class="sale-personal-section-index-block-ico">
							<img src="<?=SITE_DIR."include/logout.png"?>"/>
						</span>
						<h2 class="sale-personal-section-index-block-name">
							Выйти
						</h2>
